...
public class UpdateActivity extends AppCompatActivity {
    ...
    private com.example.studirep.DatabaseHelper databaseHandler;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseHandler = new com.example.studirep.DatabaseHelper(UpdateActivity.this);
        ...
        updateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(UpdateActivity.this, com.example.studirep.MainActivity.class);
                startActivity(i);
            }
        });
    }
